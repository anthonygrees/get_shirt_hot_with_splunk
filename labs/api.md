...
| 2a. HEC - DMC API for Classic Experience   | [Link](../labs/api.md#2a-hec---dmc-api-commands) |
| 2b. HEC - ACS API for Victoria Experience  | [Link](https://github.com/anthonygrees/get_shirt_hot_with_splunk/blob/main/labs/api.md#2b-hec---acs-api-commands) |
|            |          |
|  3. Configure IP allow lists for Splunk Cloud         |     [Link](https://github.com/anthonygrees/get_shirt_hot_with_splunk/blob/main/labs/api.md#3-configure-ip-allow-lists-for-splunk-cloud)     |
|            |          |
